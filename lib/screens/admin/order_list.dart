...
Future<void> _exportCSV() async {
  ...
  try {
    ...
    List<List<dynamic>> csvData = [
      ...
      ['ID_Commande', 'Nom_Client', 'Email', 'Produit', 'Quantite', 'Prix_Total', 'Statut', 'Date_Commande', 'Adresse_Livraison']
    ];
    ...
    for (var order in filteredOrders) {
      ...
      csvData.add([
        ...
        _escapeForExcel(order.customerEmail),
...
// Version alternative avec séparateur virgule (pour Excel EN)
Future<void> _exportCSVComma() async {
  // Même code que ci-dessus mais avec fieldDelimiter: ',' au lieu de ';'
}

// Méthode de test pour vérifier le format CSV
void _testCsvFormat() {
  final testData = [
    ['ID', 'Nom', 'Adresse'],
    ['001', 'Dupont; Martin', '123 rue de la Paix\nParis'],
    ['002', 'Leclerc "Jacques"', '456 av. des Champs\nLyon'],
  ];
