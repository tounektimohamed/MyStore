class Order {
  ...
  String customerCodePostal; // Nouveau champ Region
  ...
  Order({
    ...
    required this.customerCodePostal, // Ajouté
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'CodePostal': customerCodePostal, // Ajouté
  ...
  static Order fromMap(Map<String, dynamic> map, String id) {
    return Order(
      ...
      customerCodePostal: map['customerCodePostal'], // Ajouté
