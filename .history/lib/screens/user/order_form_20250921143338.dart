...
class _OrderFormState extends State<OrderForm> {
  ...
  final _phoneController = TextEditingController(); // Nouveau contrôleur téléphone
  final _addressController = TextEditingController();
  final _RegionController = TextEditingController(); // Nouveau contrôleur Region
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text('Prix unitaire: ${widget.product.price.toStringAsFixed(2)} DT'),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final order = Order(
          ...
          CodePostal: _CodePostal.text, // Ajouté
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 16),
                        _buildTextField(_phoneController, 'Téléphone', // Ajouté
                        ...
                        const SizedBox(height: 16),
                        _buildTextField(_addressController, 'Adresse (Rue)', // Modifié
                            maxLines: 2),
                        const SizedBox(height: 16),
                        _buildTextField(_RegionController, 'Region', // Ajouté

                        const SizedBox(height: 16),

                        _buildTextField(_CodePostal, 'Region', // Ajouté
                            maxLines: 1),
                        const SizedBox(height: 16),
                        _buildTextField(_quantityController, 'Quantité',
