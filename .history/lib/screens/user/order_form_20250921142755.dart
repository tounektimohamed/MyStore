...
class _OrderFormState extends State<OrderForm> {
  ...
  final _religionController = TextEditingController(); // Nouveau contrôleur religion
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        final order = Order(
          ...
          customerReligion: _religionController.text, // Ajouté
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildTextField(_addressController, 'Adresse (Rue)', // Modifié
                            maxLines: 2),
                        const SizedBox(height: 16),
                        _buildTextField(_religionController, 'Religion', // Ajouté
                            maxLines: 1),
                        const SizedBox(height: 16),
