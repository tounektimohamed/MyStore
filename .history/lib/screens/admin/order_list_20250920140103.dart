    ...
    onPressed: _isExporting
        ...
        : () async {
            ...
            try {
              ...
              await exportTableToCSV(context, tableData, fileName: 'commandes');
            } catch (e) {
...
Future<void> exportTableToCSV(
    BuildContext context, List<List<dynamic>> tableData,
    {String fileName = 'export'}) async {
  try {
    // Convertir la table en CSV
    String csv = const ListToCsvConverter().convert(tableData);
    ...
    if (kIsWeb) {
      ...
      // Mobile/Desktop : enregistrer dans Documents
