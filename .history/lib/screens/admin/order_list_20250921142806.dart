  ...
  Future<void> _exportCSV() async {
    ...
    try {
      ...
      List<List<dynamic>> csvData = [
        ...
        ['ID_Commande', 'Nom_Client', 'Telephone', 'Produit', 'Quantite', 'Prix_Total', 'Statut', 'Date_Commande', 'Adresse_Rue', 'Religion'] // Modifié
      ];
      ...
      for (var order in filteredOrders) {
        ...
        csvData.add([
          ...
          _escapeForExcel(order.customerReligion), // Ajouté: religion
        ]);
      }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.flag, 'Religion: ${order.customerReligion}'), // Ajouté: religion
